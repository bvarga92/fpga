...
- **max7219_ledmatrix**: monokróm LED mátrix vezérlése MAX7219 meghajtóval ([videó](https://www.youtube.com/watch?v=kkPsm4OffPs&list=PL9_VlVdB8s882QMHiqJlDpJeKWxwP5CIG))
...
- **pmodI2S2_fir**: audio FIR szûrõ PmodI2S2 codec modullal
- **pmodI2S2_loopback**: mintaprojekt a PmodI2S2 codec modulhoz
- **pmodI2S2_midi_synth**: MIDI hangszer PmodI2S2 modullal (Karplus–Strong-húrszimuláció) ([videó](https://www.youtube.com/watch?v=wc1jf62pAa8&list=PL9_VlVdB8s882QMHiqJlDpJeKWxwP5CIG))
...
- **simplecalc**: egyszerû számológép
- **tmp121_uart**: tesztprojekt a TMP121 SPI hõszenzorhoz UART adatküldéssel
